...
```{r nn-comparison}
# Placeholder for before/after maps or bar charts: Which species were found in unusual places? (How many records did each species have which were at least 1km away from NBN Atlas records)
...
row.names(recordsInBuffer)=nnSppCNm
names(recordsInBuffer)=c("latin_name","NBN_recs_in_inat_buffer",
                             "total_inat_recs",
                             "percent_new_recs")
recordsInBuffer$latin_name = nnSppSNm
